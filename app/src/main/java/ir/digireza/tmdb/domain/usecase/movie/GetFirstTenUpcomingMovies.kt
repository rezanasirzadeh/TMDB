...
class GetFirstTenUpcomingMovies @Inject constructor(private val movieRepository: MovieRepository) {

    suspend operator fun invoke(): DataState<List<Movie>> = movieRepository.getFirstTenUpcomingMovies()
}