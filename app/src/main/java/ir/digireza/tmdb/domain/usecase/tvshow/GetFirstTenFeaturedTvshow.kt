...
class GetFirstTenFeaturedTvshow @Inject constructor(private val tvshowRepository: TvshowRepository) {

    suspend operator fun  invoke(): DataState<List<Tvshow>> = tvshowRepository.getFirstTenFeaturedTvshow()
}